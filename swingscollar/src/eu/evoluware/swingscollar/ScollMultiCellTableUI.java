...
public class ScollMultiCellTableUI extends BasicTableUI
{
...
//		if (table.rowIsSingleColumn(row)){
		Rectangle r=g.getClipBounds();
		for (int i=0; i<table.getColumnCount();i++)
		{
			...
			{
				int sk=((ScollMultiCellTable)table).map.multiCellColumnAt(row,i);
				paintCell(row,sk,g,r1);
				// increment the column counter
				i+=((ScollMultiCellTable)table).map.span(row,sk)-1;
			}
		}
	}
//	}
...
// TODO: ENABLE THE FOLLOWING WHEN table.getEditor returns a useful object
